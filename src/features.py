"""
Fraud Detection System feature engineering.
...
def add_temporal_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    Domain rationale: TODO — explain why time matters for Fraud Detection System.
...
def add_aggregation_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    TODO: implement for Fraud Detection System.
    """
    df = df.copy()
...
def add_domain_features(df: pd.DataFrame) -> pd.DataFrame:
    """
    Project-specific features unique to Fraud Detection System.
