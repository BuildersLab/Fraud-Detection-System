...
TODO: update fixtures and assertions to match Fraud Detection System data schema.
"""
...
def sample_df():
    """
    Minimal synthetic DataFrame that mirrors the schema of Credit Card Fraud Detection (TBD).

    TODO: update columns to match the actual dataset for Fraud Detection System.
    Keep this small (50 to 100 rows) — it runs in CI without real data files.
    """
    n = 100
    return pd.DataFrame({
        # TODO: add columns matching Credit Card Fraud Detection (TBD) schema
        "id": range(n),
...
def test_encode_adds_expected_columns(sample_df):
    ...
    # TODO: update expected encoded column names for Fraud Detection System
